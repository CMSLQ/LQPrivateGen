...
generator = cms.EDFilter("Herwig7HadronizerFilter",
    ...
    herwig7SingleLQ = cms.vstring(
        ...
        'setup S0bar 9921561 S0bar 400.0 0.0 0.0 0.0 -1 3 1 0', 
        'create /ThePEG/ParticleData S0', 
        'setup S0 -9921561 S0 400.0 0.0 0.0 0.0 1 -3 1 0', 
        'makeanti S0bar S0', 
        ...
        #'set LesHouchesReader:FileName /eos/user/s/scooper/Leptoquarks/leptonInduced/sigGen/LQ-s-chan_DEle_M-2000.lhe', 
...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/storage/LQ/leptonInduced/sigGen/Run3/recipe/lqSignalGen/CMSSW_13_0_13/genproductions_scripts/bin/Powheg/LQ-s-chan_el8_amd64_gcc11_CMSSW_13_0_13_LQ-s-chan-nlo-dele-1000.tgz'),
